...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⚠️ Bᴏᴛ ᴏғ Mɪɴᴅfʟᴀʏᴇʀs Mɪʀʀᴏʀ", url=f"https://t.me/{temp.U_NAME}")
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('✇ Jᴏɪɴ Mɪɴᴅfʟᴀʏᴇʀ's Mɪʀʀᴏʀ ✇', url=CHNL_LNK)
                  ]]
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/arvinxoxo")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
